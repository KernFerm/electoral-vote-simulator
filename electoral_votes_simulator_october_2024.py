# Thanks to Stiched aka discord user id 220689361627250688 for implementing a lot of the code to this project as well as additional discord members for their help and support.
...
def state_voting(location, candidate_1_electoral_votes, candidate_2_electoral_votes):
    ...
    if location in counted_locations:
        print(f"{location} has already closed their polling places and decided their votes.")
    else:
