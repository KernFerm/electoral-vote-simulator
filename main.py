...
def run_simulator():
    ...
    while True:
        ...
        with open(output_file, 'w', newline='') as csvfile:
            ...
            writer.writeheader()
            writer.writerow({'Candidate': candidate_1_name, 'Votes': candidate_1_votes})
            writer.writerow({'Candidate': candidate_2_name, 'Votes': candidate_2_votes})
            writer.writerow({'Candidate': 'Total', 'Votes': total_votes})
